...
public class QuadrangleAreaComparatorTest {

    private final QuadrangleAreaComparator quadrangleAreaComparator = new QuadrangleAreaComparator();

    @Test
    public void testShouldCompareTwoQuadranglesByAreaWhenFirstQuadrangleIsLesser() {
    ...
    @Test
    public void testShouldCompareTwoQuadranglesByAreaWhenFirstQuadrangleIsBigger() {
        Point firstPoint = new Point(1.0, 1.0);
